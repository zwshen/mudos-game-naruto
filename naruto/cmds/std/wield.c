...
{
    write(@HELP
指令格式﹕wield <武器名稱> [as <左、右手>]
 
這個指令讓你裝備某件物品作武器，你必需要擁有這樣物品。

wield blade                 將刀子裝備在右手，不加參數是右手
wield blade as righthand    將刀子裝備在右手
wield blade as lefthand     將刀子裝備在左手
wield blade 2 as twohanded  將身上的第二把刀子裝備在雙手

某件武器的握法可能有一種以上，握法不同時引發的武器威力可能也不同，
你可以在握起後 identify 來獲得其他資訊。
HELP);
    return 1;
}
