...
void die()
{
    ...
    switch( this_object()->query("wp_number") ) {
        case 1: if( file_size("/mouse/wp/broad_sword.c") < 0 ) return 0;
                if( catch(wp = new("/mouse/wp/broad_sword.c")) ) return 0;
                break;
        case 2: if( file_size("/mouse/wp/thin_sword.c") < 0 ) return 0;
                if( catch(wp = new("/mouse/wp/thin_sword.c")) ) return 0;
                break;
        case 3: if( file_size("/mouse/wp/stone_lance.c") < 0 ) return 0;
                if( catch(wp = new("/mouse/wp/stone_lance.c")) ) return 0;
                break;
    }
