...
{
    int i = this_player()->query_temp("quest/music_E");
    if( arg == "機關" ) {
        if( this_player()->query_temp("quest/music_E") < -4 ) {
        ...
        this_player()->add_temp("quest/music_E", -1);
        return 1;
    }
...
int do_pushdown(string arg)
{
    int i = this_player()->query_temp("quest/music_E");
    if( arg == "機關" ) {
        if( this_player()->query_temp("quest/music_E") > 14 ) {
