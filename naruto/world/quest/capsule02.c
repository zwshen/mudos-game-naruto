...
int preCondition(object player) {
    if( player->query("level") > 39 ) return 0;
...
mapping getItem() {
    mapping item = ([
        "/world/area/sneakhole/npc/item/smaple.c": 5,     // 蜘蛛標本
        "/world/area/lake/npc/item/doll.c": 15,           // 精緻娃娃
        "/world/area/lake/npc/item/treasury.c": 5,        // 木造藏
        "/world/area/bone/npc/item/lantern.c": 3,         // 通倍利燈籠
        "/world/area/wild/npc/item/bandit_tooth.c": 5,    // 盜賊黃金牙
        "/world/area/lv60_area/npc/item/dolomite.c": 30,  // 石灰
        "/world/area/sifa_isle/npc/item/cord.c": 10,      // 火繩
    ]);
    return item;
}
